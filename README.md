...
```json
"@zero/dayline": "github:L0RIZI0/zero-dayline#v0.7.7"
```
...
Releases are **manual**. GitHub Actions → *release* → Run workflow → version `0.7.7` (no `v`). That type-checks and pushes tag `v0.7.7`.
